...
public class SendMailBkUp extends Thread
{
	private static final Logger logger = Logger.getLogger(SendMailBkUp.class);
	...
	public SendMailBkUp(String fromEmail, String toEmail, String password,
			String subject, String body, int port, String userName, String sender)
	{
		...
		this.username= "no-reply@rufinmandedata.org";
		//this.username= "support@euc.nsa.gov.ng";
		this.host = "mail.rufinmandedata.org";
		this.username = "no-reply@rufinmandedata.org";
		this.sender = sender;
