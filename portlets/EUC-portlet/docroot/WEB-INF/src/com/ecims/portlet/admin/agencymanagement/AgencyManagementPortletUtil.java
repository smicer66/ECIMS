...
public class AgencyManagementPortletUtil {
	...
	private static AgencyManagementPortletUtil adminPortletUtil=null;
	...
	public static AgencyManagementPortletUtil getInstance()
	{
		...
		{
			AgencyManagementPortletUtil.adminPortletUtil = new AgencyManagementPortletUtil();
		}
		return AgencyManagementPortletUtil.adminPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(AgencyManagementPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
	...
	public Agency getAgencyDeskByAgencyAndNameAndNotId(String deskName, String agencyName, Long id) {
		// TODO Auto-generated method stub
		Agency rt = null;
		
		try {
			
			String hql = "select rt from EndorsementDesk rt where lower(rt.endorseDeskName) = lower('" + deskName +  "') " +
					"AND  lower(rt.agency.agencyName) = lower('" + agencyName +  "') AND rt.id != " + id;
			log.info("Get hql = " + hql);
			rt = (Agency) swpService.getUniqueRecordByHQL(hql);
