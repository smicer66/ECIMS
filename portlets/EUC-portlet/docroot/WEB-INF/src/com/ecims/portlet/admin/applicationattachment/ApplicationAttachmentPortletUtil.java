...
public class ApplicationAttachmentPortletUtil {

	
	private static ApplicationAttachmentPortletUtil adminPortletUtil=null;
	...
	Logger log = Logger.getLogger(ApplicationAttachmentPortletUtil.class);
	
	public ApplicationAttachmentPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static ApplicationAttachmentPortletUtil getInstance()
	{
		if(adminPortletUtil==null)
		{
			ApplicationAttachmentPortletUtil.adminPortletUtil = new ApplicationAttachmentPortletUtil();
		}
		return ApplicationAttachmentPortletUtil.adminPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(ApplicationAttachmentPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
	...
	public Collection<ApplicationAttachmentType> getAllAttachmentTypes() {
		// TODO Auto-generated method stub
		Collection<ApplicationAttachmentType> rt = null;
		
		try {
			rt = (Collection<ApplicationAttachmentType>)swpService.getAllRecords(ApplicationAttachmentType.class);
	...
	public Collection<ApplicationAttachmentType> getAttachmentByName(
			String attachName) {
		// TODO Auto-generated method stub
		Collection<ApplicationAttachmentType> rt = null;
		...
		try {
				...
				String hql = "select rt from ApplicationAttachmentType rt where lower(rt.name) = lower('" + attachName +  "')";
				log.info("Get hql = " + hql);
				rt = (Collection<ApplicationAttachmentType>) swpService.getAllRecordsByHQL(hql);
	...
	public Collection<ApplicationAttachmentType> getAttachmentByNameNotId(
			String attachName, Long l) {
		// TODO Auto-generated method stub
		Collection<ApplicationAttachmentType> rt = null;
