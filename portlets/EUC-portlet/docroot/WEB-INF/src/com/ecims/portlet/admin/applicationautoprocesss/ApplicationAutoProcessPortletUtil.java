...
public class ApplicationAutoProcessPortletUtil {

	
	private static ApplicationAutoProcessPortletUtil adminPortletUtil=null;
	...
	Logger log = Logger.getLogger(ApplicationAutoProcessPortletUtil.class);
	
	public ApplicationAutoProcessPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static ApplicationAutoProcessPortletUtil getInstance()
	{
		if(adminPortletUtil==null)
		{
			ApplicationAutoProcessPortletUtil.adminPortletUtil = new ApplicationAutoProcessPortletUtil();
		}
		return ApplicationAutoProcessPortletUtil.adminPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(ApplicationAutoProcessPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
	...
	public Collection<WokFlowSetting> getAllWokFlowSetting() {
		// TODO Auto-generated method stub
		Collection<WokFlowSetting> rt = null;
		
		try {
			rt = (Collection<WokFlowSetting>)swpService.getAllRecords(WokFlowSetting.class);
