...
public class PortCodeMgmtPortletUtil {

	
	private static PortCodeMgmtPortletUtil adminPortletUtil=null;
	...
	Logger log = Logger.getLogger(PortCodeMgmtPortletUtil.class);
	
	public PortCodeMgmtPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static PortCodeMgmtPortletUtil getInstance()
	{
		if(adminPortletUtil==null)
		{
			PortCodeMgmtPortletUtil.adminPortletUtil = new PortCodeMgmtPortletUtil();
		}
		return PortCodeMgmtPortletUtil.adminPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(PortCodeMgmtPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
