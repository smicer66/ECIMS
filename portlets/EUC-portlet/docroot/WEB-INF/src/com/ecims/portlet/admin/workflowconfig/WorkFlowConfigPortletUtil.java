...
public class WorkFlowConfigPortletUtil {

	
	private static WorkFlowConfigPortletUtil adminPortletUtil=null;
	...
	Logger log = Logger.getLogger(WorkFlowConfigPortletUtil.class);
	
	public WorkFlowConfigPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static WorkFlowConfigPortletUtil getInstance()
	{
		if(adminPortletUtil==null)
		{
			WorkFlowConfigPortletUtil.adminPortletUtil = new WorkFlowConfigPortletUtil();
		}
		return WorkFlowConfigPortletUtil.adminPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(WorkFlowConfigPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
	...
	public PortCode getPortCodeByStateAndName(String state, String portCodeName) {
		// TODO Auto-generated method stub
		PortCode rt = null;
		
		try {
			
			String hql = "select rt from PortCode rt where lower(rt.portCode) = lower('" + portCodeName +  "') AND " +
					" lower(rt.state.name) = lower('" + state +  "')";
			log.info("Get hql = " + hql);
	...
	public PortCode getPortCodeByStateAndNameAndNotId(Long stateid, String portCode, Long id) {
		// TODO Auto-generated method stub
		PortCode rt = null;
		...
		try {
			...
			String hql = "select rt from PortCode rt where lower(rt.portCode) = lower('" + portCode +  "') AND " +
					" lower(rt.state.id) = " + stateid +  " AND rt.id != " + id;
			log.info("Get hql = " + hql);
			rt = (PortCode) swpService.getUniqueRecordByHQL(hql);
