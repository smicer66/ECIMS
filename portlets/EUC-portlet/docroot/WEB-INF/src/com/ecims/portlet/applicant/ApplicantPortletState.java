...
public class ApplicantPortletState {
	...
	private static ApplicantPortletState portletState = null;
	...
	public static enum APPLICANT_ACTIONS{
		...
		CHANGE_MY_PASSWORD, FORGOT_PASSWORD
	}
...
//			if (request.getRemoteUser() == null) {
				...
				Collection<PermissionType> peL = portletState.getApplicantPortletUtil().getPermissionsByPortalUser(portletState.getPortalUser(), swpService);
