...
public class ApplicantPortletUtil {

	
	private static ApplicantPortletUtil adminPortletUtil=null;
	...
	Logger log = Logger.getLogger(ApplicantPortletUtil.class);
	
	public ApplicantPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static ApplicantPortletUtil getInstance()
	{
		if(adminPortletUtil==null)
		{
			ApplicantPortletUtil.adminPortletUtil = new ApplicantPortletUtil();
		}
		return ApplicantPortletUtil.adminPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(ApplicantPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
