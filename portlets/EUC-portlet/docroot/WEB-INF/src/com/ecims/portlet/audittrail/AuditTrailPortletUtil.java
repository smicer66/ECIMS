...
public class AuditTrailPortletUtil {

	
	private static AuditTrailPortletUtil adminPortletUtil=null;
	...
	Logger log = Logger.getLogger(AuditTrailPortletUtil.class);
	
	public AuditTrailPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static AuditTrailPortletUtil getInstance()
	{
		if(adminPortletUtil==null)
		{
			AuditTrailPortletUtil.adminPortletUtil = new AuditTrailPortletUtil();
		}
		return AuditTrailPortletUtil.adminPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(AuditTrailPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
	...
	public Collection<AuditTrail> getAllAuditTrail() {
		...
		try {
			...
			String hql = "select rt from AuditTrail rt ORDER BY rt.date DESC";
			log.info("Get hql = " + hql);
			rt = (Collection<AuditTrail>)swpService.getAllRecordsByHQL(hql);
