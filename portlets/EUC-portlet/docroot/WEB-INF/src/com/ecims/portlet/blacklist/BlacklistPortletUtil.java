...
public class BlacklistPortletUtil {

	
	private static BlacklistPortletUtil adminPortletUtil=null;
	...
	Logger log = Logger.getLogger(BlacklistPortletUtil.class);
	
	public BlacklistPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static BlacklistPortletUtil getInstance()
	{
		if(adminPortletUtil==null)
		{
			BlacklistPortletUtil.adminPortletUtil = new BlacklistPortletUtil();
		}
		return BlacklistPortletUtil.adminPortletUtil;
	}
...
//				}
	...
	public boolean canUserEndorseThisApplication(ApplicationWorkflow awf, BlacklistPortletState portletState)
	{
...
//			} 
			...
			Collection<ApplicationWorkflow> awfL = portletState.getBlacklistPortletUtil().
...
//							ApplicationStatus.APPLICATION_STATUS_ENDORSED);
	...
	public Collection<PortalUser> getAllPortalUsers(BlacklistPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
...
Collection<ItemCategory> rt = null;
	...
	public Collection<BlackList> getBlackList() {
		// TODO Auto-generated method stub
		Collection<BlackList> rt = null;
		
		try {
			
				String hql = "select rt from BlackList rt";
				log.info("Get hql = " + hql);
				rt = (Collection<BlackList>) swpService.getAllRecordsByHQL(hql);
	...
	public Collection<BlackListLog> getBlackListLog() {
		// TODO Auto-generated method stub
		Collection<BlackListLog> rt = null;
		
		try {
			
				String hql = "select rt from BlackListLog rt";
				log.info("Get hql = " + hql);
				rt = (Collection<BlackListLog>) swpService.getAllRecordsByHQL(hql);
	...
	public Collection<BlackListLog> getBlackListLogByApplicantId(Long id) {
		// TODO Auto-generated method stub
		Collection<BlackListLog> rt = null;
		
		try {
			
				String hql = "select rt from BlackListLog rt where rt.applicant.id = " + id;
				log.info("Get hql = " + hql);
				rt = (Collection<BlackListLog>) swpService.getAllRecordsByHQL(hql);
	...
	public BlackListLog getBlackListLogByBlacklistLogId(Long id) {
		// TODO Auto-generated method stub
		BlackListLog rt = null;
		
		try {
			
				String hql = "select rt from BlackListLog rt where rt.id = " + id;
				log.info("Get hql = " + hql);
				rt = (BlackListLog) swpService.getUniqueRecordByHQL(hql);
	...
	public Applicant getApplicantByApplicantNumber(String applicantNumber) {
		// TODO Auto-generated method stub
		Applicant rt = null;
		
		try {
			
				String hql = "select rt from Applicant rt where rt.applicantNumber = '" + applicantNumber + "'";
				log.info("Get hql = " + hql);
				rt = (Applicant) swpService.getUniqueRecordByHQL(hql);
	...
	public BlackList getBlackListById(Long id) {
		...
		try {
				...
				String hql = "select rt from BlackList rt where rt.id = " + id;
				log.info("Get hql = " + hql);
