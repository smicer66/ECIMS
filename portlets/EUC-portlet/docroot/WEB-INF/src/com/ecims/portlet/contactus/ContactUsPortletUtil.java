...
public class ContactUsPortletUtil {

	
	private static ContactUsPortletUtil contactUsPortletUtil=null;
	...
	Logger log = Logger.getLogger(ContactUsPortletUtil.class);
	
	public ContactUsPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static ContactUsPortletUtil getInstance()
	{
		if(contactUsPortletUtil==null)
		{
			ContactUsPortletUtil.contactUsPortletUtil = new ContactUsPortletUtil();
		}
		return ContactUsPortletUtil.contactUsPortletUtil;
	}
	...
	public Collection<PermissionType> getPermissionsByPortalUser(PortalUser pu2, SwpService swpService2) {
		// TODO Auto-generated method stub
	...
	public Collection<Applicant> getApplicantByStatus(ApplicantStatus applicantStatus) {
		...
		try {
				...
				String hql = "select rt from Applicant rt where lower(rt.status) = lower('" + applicantStatus.getValue() +  "') " +
						"ORDER BY rt.portalUser.dateCreated DESC";
				log.info("Get hql = " + hql);
	...
	public Collection<PortalUser> getAllPortalUsers(ContactUsPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
