...
public class FeedbackPortletUtil {

	
	private static FeedbackPortletUtil feedbackPortletUtil=null;
	...
	Logger log = Logger.getLogger(FeedbackPortletUtil.class);
	
	public FeedbackPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static FeedbackPortletUtil getInstance()
	{
		if(feedbackPortletUtil==null)
		{
			FeedbackPortletUtil.feedbackPortletUtil = new FeedbackPortletUtil();
		}
		return FeedbackPortletUtil.feedbackPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(FeedbackPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
