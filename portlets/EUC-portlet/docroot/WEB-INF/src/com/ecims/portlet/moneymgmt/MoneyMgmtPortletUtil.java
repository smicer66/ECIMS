...
public class MoneyMgmtPortletUtil {

	
	private static MoneyMgmtPortletUtil adminPortletUtil=null;
	...
	Logger log = Logger.getLogger(MoneyMgmtPortletUtil.class);
	
	public MoneyMgmtPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static MoneyMgmtPortletUtil getInstance()
	{
		if(adminPortletUtil==null)
		{
			MoneyMgmtPortletUtil.adminPortletUtil = new MoneyMgmtPortletUtil();
		}
		return MoneyMgmtPortletUtil.adminPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(MoneyMgmtPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
	...
	public Agency getAgencyByTypeAndName(String agencyType, String agencyName) {
		// TODO Auto-generated method stub
		Agency rt = null;
		
		try {
			
			String hql = "select rt from Agency rt where lower(rt.agencyName) = lower('" + agencyName +  "') AND " +
					" lower(rt.agencyType) = lower('" + agencyType +  "')";
			log.info("Get hql = " + hql);
	...
	public Agency getAgencyByTypeAndNameAndNotId(String agencyType, String agencyName, Long id) {
		// TODO Auto-generated method stub
		Agency rt = null;
		...
		try {
			...
			String hql = "select rt from Agency rt where lower(rt.agencyName) = lower('" + agencyName +  "') AND " +
					" lower(rt.agencyType) = lower('" + agencyType +  "') AND rt.id != " + id;
			log.info("Get hql = " + hql);
			rt = (Agency) swpService.getUniqueRecordByHQL(hql);
	...
	public Object getAllEntity(Class class1) {
		// TODO Auto-generated method stub
		Object rt=null;
		rt= swpService.getAllRecords(class1);
		return rt;
	}

	public Currency getCurrencyBySymbolOrName(String currencyName,
			String htmlName, Long id, Boolean edit ) {
		// TODO Auto-generated method stub
		Currency rt = null;
		
		try {
			
			String hql = "select rt from Currency rt where lower(rt.name) = lower('" + currencyName +  "') OR " +
					" lower(rt.htmlEntity) = lower('" + htmlName +  "')" + (edit==Boolean.TRUE ? (" AND rt.id != " + id) : "");
			log.info("Get hql = " + hql);
			rt = (Currency) swpService.getUniqueRecordByHQL(hql);
