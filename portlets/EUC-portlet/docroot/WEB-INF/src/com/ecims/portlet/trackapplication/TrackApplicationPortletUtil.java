...
public class TrackApplicationPortletUtil {

	
	private static TrackApplicationPortletUtil adminPortletUtil=null;
	...
	Logger log = Logger.getLogger(TrackApplicationPortletUtil.class);
	
	public TrackApplicationPortletUtil() {
		swpService = serviceLocator.getSwpService();
	}
	
	public static TrackApplicationPortletUtil getInstance()
	{
		if(adminPortletUtil==null)
		{
			TrackApplicationPortletUtil.adminPortletUtil = new TrackApplicationPortletUtil();
		}
		return TrackApplicationPortletUtil.adminPortletUtil;
	}
	...
	public Collection<PortalUser> getAllPortalUsers(TrackApplicationPortletState portletState) {
		// TODO Auto-generated method stub
		Collection<PortalUser> rt = null;
	...
	public Collection<AuditTrail> getAllAuditTrail() {
		// TODO Auto-generated method stub
		Collection<AuditTrail> rt = null;
		
		try {
			rt = (Collection<AuditTrail>)swpService.getAllRecords(AuditTrail.class);
	...
	public Collection<ApplicationWorkflow> getApplicationWorkflowByAppNo(
			String appNo) {
		// TODO Auto-generated method stub
		Collection<ApplicationWorkflow> rt = null;
		try {
			String hql = "select rt from ApplicationWorkflow rt where lower(rt.application.applicationNumber) = " +
					"lower('" + appNo +  "')";
			log.info("HQL = " + "select rt from ApplicationWorkflow rt where lower(rt.application.applicationNumber) = " +
					"lower('" + appNo +  "'))");
