	  ...
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" method="post" enctype="application/x-www-form-urlencoded">
		  ...
		  <div align="center" style="padding-bottom:5px"> <strong>Password:</strong>
	        <div>
	          <input class="clear form-control" type="password" value="<%=portletState.getActivationEmail()==null ? "" : portletState.getActivationEmail() %>" name="password" id="password" placeholder="Provide your password" />
	        </div>
	      </div>
