...
<div class="list-group-item">
	<form  id="startRegFormId" action="<%=proceed%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
                            ...
                            Step 2 of 3: Add Biometric Data
                            ...
                            <div class="panel panel-default">
	                                    ...
	                                    <div class="row">
	                                        <div class="col-lg-5">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" name="certNo" id="certNo" value="<%=RandomStringUtils.random(6, false, true)%>"/>
	                                            </div>
	                                        </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-5">
                                        	<input type="submit" name="btnSaveApplication" value="Cancel" id="SaveApplication" class="btn btn-danger btn-cons" style="float:left" onClick="javascript:submitForm('cancelissue')">
                                			<input type="submit" name="btnSaveApplication" value="Generate Certificate" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onClick="javascript:submitForm('issuecertificate')">
                                        </div>
