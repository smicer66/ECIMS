...
<div class="list-group-item">
	<form  id="startRegFormId" action="<%=proceed%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
							...
							<div class="panel panel-default">
                                ...
                                <input type="submit" name="btnSaveApplication" value="Cancel" id="SaveApplication" class="btn btn-danger btn-cons" style="float:left" onClick="javascript:submitForm('cancelflag')">
                                <input type="submit" name="btnSaveApplication" value="Next" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onClick="javascript:submitForm('raiseflag')">
                            </div>
	</form>
</div>
