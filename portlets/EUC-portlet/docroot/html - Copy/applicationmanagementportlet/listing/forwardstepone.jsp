	...
	<form  id="startRegFormId" action="<%=proceed%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Step 1 of 2: Forward Application To Agency                   
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                Forward This Application to this Agency:
							...
							<div class="panel panel-default">
                                ...
                                <input type="submit" name="btnSaveApplication" value="Cancel" id="SaveApplication" class="btn btn-danger btn-cons" style="float:left" onClick="javascript:submitForm('cancelfwdstepone')">
                                <input type="submit" name="btnSaveApplication" value="Next" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onClick="javascript:submitForm('fwdtoagencystepone')">
                            </div>
	</form>
</div>
