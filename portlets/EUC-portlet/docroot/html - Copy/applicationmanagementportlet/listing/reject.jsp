...
<div class="list-group-item">
	<form  id="startRegFormId" action="<%=proceed%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="row" style="padding: 16px">
                                            ...
                                            <div class="col-lg-6">
                                                Item Category:
                                                <%=portletState.getDescription()==null ? "" : portletState.getDescription()%>
                                                
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <textarea name="rejectcomment" id="rejectcomment" placeholder="Provide information for rejecting this application"><%=portletState.getRejectComment()==null ? "" : portletState.getRejectComment()%></textarea>
                                        </div>
                                    </div>
							...
							<div class="panel panel-default">
                                ...
                                <input type="submit" name="btnSaveApplication" value="Proceed With Rejection" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onclick="javascript:submitForm('rejectapplication')">
                            </div>
	</form>
</div>
