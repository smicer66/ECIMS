...
%>
		...
		<portlet:actionURL var="disputedapplications" name="processAction">
			<portlet:param name="action"
				value="<%=VIEW_TABS.LIST_DISPUTED_APPLICATIONS_NSA.name()%>" />
		</portlet:actionURL>
...
}else if(portletState.getCurrentTab()!=null && portletState.getCurrentTab().equals(VIEW_TABS.LIST_DISPUTED_APPLICATIONS_NSA))
{
...
<div style="padding-top: 20px">
	...
	<div style="padding:2px; float:left; font-weight:bold">
		...
		Disputed EUC Applications</div></a>
	</div>
	<div style="padding:2px; float:left; font-weight:bold">
