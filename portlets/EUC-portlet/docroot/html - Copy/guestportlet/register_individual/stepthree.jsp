			  ...
			  <legend>Means of Identification
				  ...
				  <div style="padding-bottom:5px">
					<div>
					  	...
					  	<img src="<%=folder + "/uploadedfiles/" + portletState.getIdentificationFileName()%>" height="50px;">
					</div>
				  </div>
				  <div style="padding-bottom:5px">
					<div>
				  ...
				  <div style="padding-bottom:5px">
					<div>
					  	...
					  	<%=portletState.getIssueDate()!=null ? portletState.getIssueDate() : "N/A"%>
					</div>
				  </div>
				  <div style="padding-bottom:5px">
					<div>
						...
						<div>
						  <%=portletState.getIdentificationExpiryDate()!=null ? portletState.getIdentificationExpiryDate() : "N/A"%>
						</div>
					</div>
				  </div>
				  <%
