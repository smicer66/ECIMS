...
<portlet:actionURL var="proceedToStepThree" name="processAction">
	<portlet:param name="action"
		value="<%=AGENCY_ACTIONS.CREATE_NEW_AGENCY.name()%>" />
</portlet:actionURL>
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" data-validate="parsley" method="post" enctype="application/x-www-form-urlencoded">
	     <fieldset>
			  ...
			  <div style="padding-bottom:5px"><strong>Agency Type:</strong>
				...
				<select class="clear form-control formwidth50" name="agencyType" data-required="true" id="agencyType">
					...
					for(Iterator<AgencyType> it = agencyTypeList.iterator(); it.hasNext();)
					{
						...
						if(!at.getValue().equals(AgencyType.ONSA_GROUP.getValue()))
						{
						%>
						<option value="<%=at.getValue()%>"><%=at.getValue()%></option>
						<%
						}
					}
					%>
			  ...
			  <div style="padding-bottom:5px"> <strong>Agency Name:<span style="color:red">*</span></strong>
				<div>
				  <input class="clear form-control formwidth50" type="text" data-required="true" value="<%=portletState.getAgencyName()==null ? "" : portletState.getAgencyName() %>" name="agencyName" id="agencyName" placeholder="Provide Name of Agency" />
				</div>
			  </div>
			  <div style="padding-bottom:5px"><strong>Contact Name:<span style="color:red">*</span></strong>
				<div>
				  <input class="clear form-control formwidth50" type="text" data-required="true" value="<%=portletState.getContactName()==null ? "" : portletState.getContactName() %>" name="contactName" id="contactName" placeholder="Provide Agency's Contact Persons Name" />
				</div>
			  </div>
			  <div style="padding-bottom:5px"><strong>Agency Phone:</strong>
				<div>
				  <input class="clear form-control formwidth50" type="text" value="<%=portletState.getAgencyPhone()==null ? "" : portletState.getAgencyPhone() %>" name="agencyPhone" id="agencyPhone" placeholder="Provide Agency's Phone Number" />
				</div>
			  </div>
			  <div style="padding-bottom:5px"><strong>Agency Email:<span style="color:red">*</span></strong>
				<div>
				  <input class="clear form-control formwidth50" type="text" data-required="true" value="<%=portletState.getAgencyEmail()==null ? "" : portletState.getAgencyEmail() %>" name="agencyEmail" id="agencyEmail" placeholder="Provide Agency's Email Address" />
				</div>
			  </div>
	      ...
	      <div>
	      	...
	      	<button type="submit" class="btn btn-success" style="float:right" onclick="javascript:submitForm('createnewagency')">Create New Agency</button>
