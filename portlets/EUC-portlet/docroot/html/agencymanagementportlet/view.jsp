...
{
	if(portletState.getCurrentTab()!=null && portletState.getCurrentTab().equals(VIEW_TABS.VIEW_ALL_AGENCY))
	{
		%>
		<jsp:include page="/html/agencymanagementportlet/agencylisting.jsp" flush="" />
		<%
	}else if(portletState.getCurrentTab()!=null && portletState.getCurrentTab().equals(VIEW_TABS.VIEW_ALL_DESK))
	{
		%>
		<jsp:include page="/html/agencymanagementportlet/desklisting.jsp" flush="" />
		<%
	}else if(portletState.getCurrentTab()!=null && portletState.getCurrentTab().equals(VIEW_TABS.VIEW_NEW_AGENCY))
	{
		%>
		<jsp:include page="/html/agencymanagementportlet/newagency.jsp" flush="" />
		<%
	}else if(portletState.getCurrentTab()!=null && portletState.getCurrentTab().equals(VIEW_TABS.VIEW_NEW_DESK))
	{
		%>
		<jsp:include page="/html/agencymanagementportlet/newdesk.jsp" flush="" />
		<%
	} 
	else
	{
