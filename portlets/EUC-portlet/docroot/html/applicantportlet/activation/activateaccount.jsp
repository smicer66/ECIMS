...
<div style="padding-left:10px; padding-right:10px; width:900px">
	...
	<div class="panel-heading"><span style="color:white; font-weight: bold">Step 1 of 2: Activate Your ECIMS Account</span></div>
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" method="post" enctype="application/x-www-form-urlencoded">
	      ...
	      <div align="center">
	      	...
	      	<input type="hidden" value="<%=kickstartEmail.getEmailAddress()!=null ? kickstartEmail.getEmailAddress() : "" %>" name="email" id="email" />
