...
<div class="panel panel-info">
  	...
  	<div class="panel-body">
		<p>Click on View Applicant Details button to view details about an applicant</p>
  	</div>
  	<%
		  }
  	%>
		...
		<legend>Applicants Listing</legend>
		  ...
		  if(portletState.getApplicantListing()!=null && portletState.getApplicantListing().size()>0)
		  {
			  ...
			  for(Iterator<Applicant> iter = portletState.getApplicantListing().iterator(); iter.hasNext();)
			  {
				  ...
				  PortalUser pu = portletState.getApplicantPortletUtil().getPortalUserByApplicant(applicant);
				  %>
				  <tr>
				  	<td><%=applicant!=null ? sdf.format(new Date((pu.getDateCreated()).getTime()))  : "" %></td>
