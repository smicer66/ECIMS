	  ...
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=handleApproval%>" method="post" enctype="application/x-www-form-urlencoded">
		  ...
		  <div style="padding-bottom:5px; clear:both"><div><strong>State:<span style="color:red"></span></strong></div>
	        <div>
				<div style="padding-right:10px">
						<%=portletState.getSelectedApplicant().getPortalUser().getState()==null ? "N/A" : portletState.getSelectedApplicant().getPortalUser().getState().getName() %>
				</div>
	        </div>
	      </div>
		  ...
		  <div style="padding-bottom:5px"><strong>Passport Photo:</strong>
	        <div>
			<a target="blank" style="border:0px;" href="<%=folder + "/uploadedfiles/" + (portletState.getSelectedApplicant().getPortalUser().getPassportPhoto()==null ? "" : portletState.getSelectedApplicant().getPortalUser().getPassportPhoto())%>">
		  ...
		  <fieldset>
			  <legend>Means of Identification
				  ...
				  <div style="padding-bottom:5px">
					<div>
					  	<strong>Means of Identification Photo:</strong><br>
				  ...
				  <div style="padding-bottom:5px">
					<div>
					  	<strong>Means of Identification Number:</strong> 
						<div>
	      ...
	      <div>
			...
			<%
	      	...
	      	<button type="submit" name="back" class="btn btn-danger" style="float:left" onclick="javascript:submitForm('back')">Go Back</button>
	      	<%
	      	if(portletState.getSelectedApplicant().getStatus().equals(ApplicantStatus.APPLICANT_STATUS_UNAPPROVED))
	      	{
		      	if(portletState!=null && portletState.getPermissionList().contains(PermissionType.PERMISSION_MANAGE_APPLICANT))
