...
<portlet:actionURL var="proceedToStepThree" name="processAction">
	<portlet:param name="action"
		value="<%=APPLICANT_ACTIONS.CHANGE_MY_PASSWORD.name()%>" />
</portlet:actionURL>
	...
	<div class="panel  panel-primary">
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" method="post" enctype="multipart/form-data">
		  ...
		  <div style="padding-bottom:5px"> <strong>Current Password:<span style="color:red">*</span></strong>
	        <div>
	          <input class="clear form-control" type="password" value="" name="oldpassword" id="oldpassword" placeholder="Type Your Current Password" />
	        </div>
	      </div>
	      <div style="padding-bottom:5px"><strong>New Password:<span style="color:red">*</span></strong>
	        <div>
	          <input class="clear form-control" type="password" value="" onKeyUp="passwordStrength(this.value)" name="newpassword" id="newpassword" placeholder="Provide Your New Password" />
	        </div>
	      </div>
	      <div style="padding-bottom:5px"><strong>Retype New Password:</strong>
	        <div>
	          <input class="clear form-control" type="password" value="" name="rnewpassword" id="rnewpassword" placeholder="Retype Your New Password" />
	        </div>
	      </div>
	      ...
	      <div>
	      	...
	      	<button type="submit" class="btn btn-success" id="savenutton" disabled="disabled" style="float:right" onclick="javascript:submitForm('proceed')">Change My Password</button>
...
function passwordStrength(password)
{
	...
	if (password.length > 12) score++;
	 ...
	 if(score>3)
	 {
		 document.getElementById("savenutton").disabled=false;
		 return true;
	 }else
	 {
		 document.getElementById("savenutton").disabled=true;
		 return false;
	 }
}
</script>