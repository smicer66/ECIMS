	  ...
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepFour%>" method="post" enctype="application/x-www-form-urlencoded">
		  ...
		  <div style="padding-bottom:5px">
			<div>
				<strong>Your Passport Photo:</strong> <img src="<%=folder + File.separator + "uploadedfiles" + File.separator + portletState.getPassportPhoto()%>" height="50px;">
			</div>
		  </div>
		  ...
		  <fieldset>
			  <legend>Company Details
				  ...
				  <div style="padding-bottom:5px">
					<div>
					  	<strong>Your Company Logo:</strong> <img src="<%=folder + File.separator + "uploadedfiles" + File.separator + portletState.getCompanyLogo()%>" height="50px;">
					</div>
				  </div>
				  <div style="padding-bottom:5px">
					<div>
					  	<strong>Your Company's Certificate of Incorporation: <img src="<%=folder + File.separator + "uploadedfiles" + File.separator + portletState.getCacCertificate()%>" height="50px;">
					</div>
				  </div>
		  <fieldset>
