	...
	<div class="panel  panel-primary">
	  ...
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepTwo%>" method="post" enctype="application/x-www-form-urlencoded">
		  ...
		  <div style="padding-bottom:5px"><strong>Account Type:</strong>
		  	<fieldset>
				...
				{
				%>
					<input class="clear form-control" type="radio" value="1" name="accountType" id="accountType" />Individual
				  	<input class="clear form-control" type="radio" value="0" name="accountType" id="accountType" />Company
				<%
				}else if(portletState.getAccountType().equals("1"))
				{
				%>
					<input class="clear form-control" checked="checked" type="radio" value="1" name="accountType" id="accountType" />Individual
				  	<input class="clear form-control" type="radio" value="0" name="accountType" id="accountType" />Company
				...
				%>
					<input class="clear form-control" type="radio" value="1" name="accountType" id="accountType" />Individual
				  	<input class="clear form-control" checked="checked" type="radio" value="0" name="accountType" id="accountType" />Company
				<%
				}
				%>
	      ...
	      <div>
	      	<button type="submit" class="btn btn-success" style="float:right">Proceed to Next</button>
	      </div>
	    </form>
	  </div>
	</div>
