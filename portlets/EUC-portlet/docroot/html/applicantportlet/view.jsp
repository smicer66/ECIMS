...
{
	%>
	<jsp:include page="/html/applicantportlet/activation/activateaccount.jsp" flush="" />
	<%
}else
{
	if(pend!=null)
	{
		...
		%>
		<jsp:include page="/html/applicantportlet/applicantlisting/applicantlisting.jsp" flush="" />
		<%
	}else
	{
		...
		{
		%>
		<jsp:include page="/html/applicantportlet/stepone.jsp" flush="" />
		<%
