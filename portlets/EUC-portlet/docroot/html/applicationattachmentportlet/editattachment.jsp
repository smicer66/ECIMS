...
<portlet:actionURL var="proceedToStepThree" name="processAction">
	<portlet:param name="action"
		value="<%=HANDLE_ACTIONS.NEW_ATTACHMENT_TYPE.name()%>" />
</portlet:actionURL>
...
<div style="padding-left:10px; padding-right:10px;" class="col-sm-9 panel panel-default" role="news">
	<h4>Update An Attachment</h4>
	<div class="panel  panel-primary">
	  <div class="panel-heading"><span style="color:white; font-weight: bold">Update Attachment</span></div>
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" data-validate="parsley" method="post" enctype="application/x-www-form-urlencoded">
	     <fieldset>
			  <legend>Attachment Details
			  </legend>
			  
			  <div style="padding-bottom:5px"><strong>Attachment Name:</strong>
			  	<div style="color:red; font-size:11px">Do not use special characters</div>
				<div>
				<input class="clear form-control formwidth50" type="text" 
				data-required="true" value="<%=portletState.getAttachmentType()==null ? "" : portletState.getAttachmentType() %>" 
				name="attachName" id="attachName" placeholder="Provide Name of Attachment" />
	      ...
	      <div>
	      	...
	      	<input type="hidden" value="<%=portletState.getSelectedAttachmentType()==null ? "" : portletState.getSelectedAttachmentType().getId() %>" name="actId" id="actId" />
	      	<button type="submit" class="btn btn-success" style="float:right" onclick="javascript:submitForm('saveattachment')">Save Changes</button>
	...
	<div style="padding:top:10px">
		<ul>
			<li>
				...
				<div>Do not make use of special characters</div>
