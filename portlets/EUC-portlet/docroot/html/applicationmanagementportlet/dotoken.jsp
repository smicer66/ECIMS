...
<div style="padding:10px">
	<div class="panel panel-info">
	  	...
	  	<div class="panel-body">
	        ...
	        <h3>EUC Application Approval</h3><br>
<div class="row" style="padding:10px;">
                           	<strong>Select Token Type</strong><br>
                               <select name="tokenType" style="padding:5px;">
                               		<option value="-1">-Select An Option-</option>
                               		<option value="Software Token">Software Token (SMS Option)</option>
                               		<option value="Hardware Token">Hardware Token (Token Device)</option>
                               </select> 
</div>
<div class="row" style="padding-left:10px;">
                           	<strong>Token Code (Displayed on Token for hardware token or in SMS message for Software token)</strong>
                               <input type="text" name="token" class="clear form-control formwidth50" placeholder="Please enter the token you received" id="token">
</div>
<div class="row" style="padding-left:10px;">
	
                           	<strong>Retype Your Token Code</strong>
                               <input type="text" name="tokenConfirm" class="clear form-control formwidth50" placeholder="Please Re-enter the token you typed" id="tokenConfirm">
</div>
                           <!-- .panel-body -->
	...
	<div class="form-group">
				...
				<div class="row">
	             ...
	             Go Back</button>
	             <button type="submit" name="btnSaveApplication" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onclick="javascript:submitForm('approveWithToken')">
