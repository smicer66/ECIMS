...
<div style="padding:10px">
	<div class="panel panel-info">
	  	...
	  	<div class="panel-body">
	        ...
	        <h3>Set Your Token Pin</h3><br>
	        <div>Please provide a token pin that you can always remember</div>
	
                           <div class="row" style="padding-left:10px;">
                           	<strong>Memorable Token Pin</strong>
                               <input type="password" name="token" class="clear form-control formwidth50" placeholder="Please enter the token you received" id="token">
</div>
<div class="row" style="padding-left:10px;">
	
                           	<strong>Confirm Memorable Token Pin</strong>
                               <input type="password" name="tokenConfirm" class="clear form-control formwidth50" placeholder="Please Re-enter the token you typed" id="tokenConfirm">
</div>
                           <!-- .panel-body -->
	...
	<div class="form-group">
				...
				<div class="row">
	             ...
	             Cancel</button>
	             <button type="submit" name="btnSaveApplication" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onclick="javascript:submitForm('setTokenPin')">
	             Next</button>
	         </div>
		</form>
		</div>
