...
<div style="padding-left:10px; padding-right:10px; width:900px">
	...
	<div class="panel  panel-primary">
	  <div class="panel-heading"><span style="color:white; font-weight: bold">Step 1 of 3: Scan Barcode or Enter Certificate Number Manually?</span></div>
	...
	<form  id="startRegFormId" action="<%=proceed%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
				...
				<%=portletState.getApplicationWorkflow()!=null ? portletState.getApplicationWorkflow().getApplication().getApplicationNumber() : ""%> 
                                ...
                                <div class="row">
                                    <div class="">
                                        <div class="form-group">
                                            <button type="submit" name="btnSaveApplication" id="SaveApplication" class="btn btn-success btn-cons" style="float:left" onClick="javascript:submitForm('scanbarcode')">
                                            Scan Certificate Barcode</button>
                                            <button type="submit" name="btnSaveApplication" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onClick="javascript:submitForm('entercertificate')">
                                            Enter Certificate Number</button>
                                        </div>
                                    </div>
...
{
	if(clicked=='scanbarcode')
	{
		alert('This feature has not been enabled yet. Please select the other option to proceed');
	}else
	{
