...
<div style="padding-left:10px; padding-right:10px; width:900px">
	...
	<div class="panel  panel-primary">
	  <div class="panel-heading"><span style="color:white; font-weight: bold">Step 2 of 3: Certificate Number</span></div>
	...
	<form  id="startRegFormId" action="<%=proceed%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
									...
									<%=portletState.getApplicationWorkflow()!=null ? portletState.getApplicationWorkflow().getApplication().getApplicationNumber() : ""%> 
	                                    ...
	                                    <div class="row">
	                                        <div class="col-lg-5">
	                                            <div class="form-group">
	                                                <strong>Certificate Number:<br></strong>
	                                                <input type="text" data-required="true" placeholder="Enter Certificate Number Here" name="certificateNumber" id="certificateNumber" value=""/>
	                                            </div>
	                                        </div>
                                        ...
                                        <div class="">
                                        	<button type="submit" name="btnSaveApplication" id="SaveApplication" class="btn btn-danger btn-cons" style="float:left" onClick="javascript:submitForm('cancelissuecertsteptwo')">
                                			Cancel</button>
                                			<button type="submit" name="btnSaveApplication" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onClick="javascript:submitForm('issuecertificateStepTwo')">
                                			Next</button>
                                        </div>
