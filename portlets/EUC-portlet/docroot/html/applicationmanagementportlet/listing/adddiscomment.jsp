...
<div class="list-group-item">
	<form  id="startRegFormId" action="<%=proceed%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-5">
                                                <div class="form-group">
                                                    Add Comments: <div style="color:red">*</div>
                            						  <textarea name="cmnt" id="comments" class="form-control" placeholder="Provide comments if necessary"><%=portletState.getCommentsForward()==null ? "" : portletState.getCommentsForward()%></textarea>
                                                </div>
                                        </div>
							...
							<div class="panel panel-default">
                                ...
                                <input type="submit" name="btnSaveApplication" value="Cancel" id="SaveApplication" class="btn btn-danger btn-cons" style="float:left" onClick="javascript:submitForm('canceldisendorsenow')">
                                <input type="submit" name="btnSaveApplication" value="Dis-Endorse Application" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onClick="javascript:submitForm('disendorseNow')">
                            </div>
	</form>
</div>
