		...
		<legend>Application Listing</legend>
		  ...
		  if(portletState.getApplicationWorkFlowListing()!=null && portletState.getApplicationWorkFlowListing().size()>0)
		  {
			  ...
			  for(Iterator<ApplicationWorkflow> iter1 = portletState.getApplicationWorkFlowListing().iterator(); iter1.hasNext();)
			  {
				  ...
				  if(pu.getStatus().equals(UserStatus.USER_STATUS_ACTIVE))
				  {
				  ...
				  <tr>
					...
					<td><%=app.getApplication().getApplicant()!=null ? (app.getApplication().getApplicant().getApplicantNumber()==null ? "N/A" : app.getApplication().getApplicant().getApplicantNumber()) : app.getApplication().getPortalUser().getAgency().getAgencyName()%></td>
					<td><%=status%></td>
					<td>
		  ...
		  {
			  if(portletState.getCurrentTab()!=null && portletState.getCurrentTab().equals(VIEW_TABS.LIST_ALL_APPLICATIONS_EU))
			  {
			  %>
