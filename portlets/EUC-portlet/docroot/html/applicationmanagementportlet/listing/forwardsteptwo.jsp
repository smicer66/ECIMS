...
<div style="padding-left:10px; padding-right:10px; width:900px">
	...
	<div class="panel  panel-primary">
	  <div class="panel-heading"><span style="color:white; font-weight: bold">Step 2 of 2: Forward Application To Agency</span></div>
	  <div class="panel-body">
		...
		<legend>Application Listing</legend>
		  ...
		  %>
		<div>
		Provide Comments/Reasons for Endorsing this application<span style="color:red; font-size:11px">*</span>
		<textarea name="cmnt" id="cmnt" style="width:500px; height:60px" placeholder="Provide your comments before you can proceed"></textarea></div>
		<button type="submit" name="gobacktosteptwo" value="Go Back" class="btn btn-danger" onclick="javascript:submitForm('gobackfwdsteptwo')">
