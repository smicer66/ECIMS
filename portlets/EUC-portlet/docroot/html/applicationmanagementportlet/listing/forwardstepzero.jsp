	...
	<form  id="startRegFormId" action="<%=proceed%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
									...
									<option value="0">No, Process This Application Using Automated Workflow</option>
									<option value="1">Yes, Allow Me Decide How To Handle This Application</option>
												  </select>
							...
							<div class="panel panel-default">
                                ...
                                <button type="submit" name="btnSaveApplication" id="SaveApplication" class="btn btn-danger btn-cons" style="float:left" onClick="javascript:submitForm('cancelfwdstepzero')">
                                Go Back</button>
                                <button type="submit" name="btnSaveApplication" id="SaveApplication" class="btn btn-success btn-cons" style="float:right" onClick="javascript:submitForm('processapplication')">
