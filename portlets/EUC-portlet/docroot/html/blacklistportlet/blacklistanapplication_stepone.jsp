...
<portlet:actionURL var="searchApplicant" name="processAction">
	<portlet:param name="action"
		value="<%=BLACKLIST_ACTIONS.BLACKLIST_AN_APPLICANT_STEP_ONE.name()%>" />
</portlet:actionURL>

<div style="padding:10px" id="print-content">
<div class="panel panel-info">
  	<!-- Default panel contents -->
  	<div class="panel-heading"><strong>BlackList An Agency or Applicant</strong></div>
  	<div class="panel-body">
  		<p><b style="color: red">Step One: Search for Applicant</b></p>
		
  	</div>
		<form  id="userListFormId" action="<%=searchApplicant%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
			
			  <!-- brnr/yzOiNfKomD330VFLc5B9qE= -->
			  <table width="100%" class="table table-hover" id="btable">
			  	<tr>
			  		<td><b>APPLICANT NUMBER</b></td>
			  		<td><input type="text" name="applicantNumber" value=""></td>
			  	</tr>
			   </table>
		...
		<input type="submit" name="search" value="Search" class="btn btn-success btn-cons" style="float:right" />
