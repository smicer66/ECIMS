...
<div class="panel panel-info">
  	...
  	<div class="panel-heading"><strong>List of Agency's OR Individuals Currently Blacklisted</strong></div>
  	<div class="panel-body">
		...
		<legend>Blacklist Listing</legend>
		  <%
		  if(portletState.getBlackListListing()!=null && portletState.getBlackListListing().size()>0)
		  {
			  %>
			  ...
			  <table width="100%" class="table table-hover" id="btable">
				...
				<%
			  for(Iterator<BlackList> iter1 = portletState.getBlackListListing().iterator(); iter1.hasNext();)
			  {
				  
				  BlackList blackList= iter1.next();
							...
							<div class="btn-group">
								<button type="button" class="btn btn-success">Action</button>
							  	...
							  	<ul class="dropdown-menu" role="menu">
									<li><a href="javascript: handleButtonAction('removeFromBlackList', '<%=blackList.getId()%>')">Remove From Blacklist</a></li>
									<li><a href="javascript: handleButtonAction('viewBlackListHistory', '<%=blackList.getApplicant().getId()%>')">View Blacklist History</a></li>
									<li><a href="javascript: handleButtonAction('removeFromBlackList', '<%=blackList.getId()%>')">View Blacklist Details</a></li>
...
function handleButtonAction(action, usId){
	...
	if(action=='removeFromBlackList' || action=='viewBlackListHistory')
	{
