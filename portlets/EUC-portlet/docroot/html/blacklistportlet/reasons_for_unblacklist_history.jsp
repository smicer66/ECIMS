...
BlackListLog blackList = portletState.getCurrentBlackListLog();
  	...
  	<div class="panel-body">
  		<p>Provide Reasons for BlackListing Agency</p>
			  ...
			  <table width="100%" class="table table-hover" id="btable">
			  	...
			  	<tr>
			  		<td><b>Account Was Created On</b></td>
			  		<td><%=blackList.getPortalUser().getDateCreated()%></td>
			  	</tr>
			  	<tr>
			  		<td><b>Applicant Email Address</b></td>
			  		<td><%=blackList.getPortalUser().getEmailAddress()%></td>
			  	</tr>
			  	<tr>
			  		<td>Reason For Blacklist</td>
