...
<portlet:actionURL var="allcertificates" name="processAction">
	...
	<portlet:param name="action"
		...
		<portlet:actionURL var="recalledcertificates" name="processAction">
			<portlet:param name="action"
				value="<%=VIEW_TABS.VIEW_RECALLED_CERTIFICATES.name()%>" />
		</portlet:actionURL>
...
String recalledcertClass = "label-default";
...
{
	recalledcertClass="label-primary";
}else
{
	allcertClass="label-primary";
}
...
%>
	...
	<div style="padding:2px; float:left; font-weight:bold">
		<a href="<%=recalledcertificates%>">
		<div class="label <%=recalledcertClass%>" style="padding:10px; ">
		Recalled Certificates</div></a>
	</div>
