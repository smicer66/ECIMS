...
<portlet:actionURL var="proceed" name="processAction">
	<portlet:param name="action"
		value="<%=CERTLIST_ACTIONS.UPLOAD_A_CERT.name()%>" />
</portlet:actionURL>
<div style="padding-left:10px; padding-right:10px; width:900px">
	<h4>Upload Certificate</h4>
	<div class="panel  panel-primary">
	  <div class="panel-heading"><span style="color:white; font-weight: bold">Confirm Certificate Printing</span></div>
	...
	<form  id="startRegFormId" action="<%=proceed%>" method="post" enctype="multipart/form-data" style="padding:10px">
							...
							<div class="panel panel-default">
                                ...
                                <input type="hidden" name="selectedUserAction" value="issuecertificateStepThree" id="selectedUserAction">
                                <input type="hidden" name="selectedApplications" value="<%=portletState.getCertificateSelected()==null ? "" : portletState.getCertificateSelected().getId() %>" id="selectedApplications">
