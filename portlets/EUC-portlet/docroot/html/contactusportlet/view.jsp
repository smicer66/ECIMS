...
{
	%>
	<jsp:include page="/html/contactusportlet/contactus.jsp" flush="" />
	<%
}else if(portletState.getPortalUser()!=null && portletState.getPortalUser().getRoleType().getName().equals(RoleTypeConstants.ROLE_END_USER))
{
	%>
	<jsp:include page="/html/contactusportlet/admin/contactuslist.jsp" flush="" />
	<%
}else
{
	%>
