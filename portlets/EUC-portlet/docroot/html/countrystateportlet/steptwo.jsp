...
<div style="padding-left:10px; padding-right:10px;" class="col-sm-9 panel panel-default" role="news">
	...
	<form  id="startRegFormId" data-validate="parsley" action="<%=proceed%>" method="post" enctype="application/x-www-form-urlencoded" style="padding:10px">
                            ...
                            <div class="panel">
                                ...
                                <select <%if(req.equals(Boolean.FALSE)){ %> data-required="true" <%} %> name="HSCode" id="HSCode" class="form-control">
									...
									%>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input <%if(req.equals(Boolean.FALSE)){ %> data-required="true" <%} %> name="txtDescription" style="width:200px" value="<%=portletState.getDescription()==null ? "" : portletState.getDescription()%>" type="text" id="Description" class="form-control" placeholder="Description">
											...
											<div class="col-lg-2">
												...
												<select <%if(req.equals(Boolean.FALSE)){ %> data-required="true" <%} %> name="txtQuantityUnit" id="txtQuantityUnit" class="form-control" style="width:65px;">
												<%
                                        ...
                                        <div class="col-lg-2">
											...
											<input <%if(req.equals(Boolean.FALSE)){ %> data-required="true" <%} %> name="txtAmount" value="<%=portletState.getAmount()==null ? "" : portletState.getAmount()%>" type="text" id="Amount" title="Amount" class="form-control" placeholder="Unit Cost">
                                        </div>
