...
<%@page
	import="com.ecims.portlet.currencymanagement.ItemCategorySubManagementPortletUtil"%>
...
String subitemCategoryKey = renderRequest.getParameter("subcategoryKey");

try {
	util.deleteItemCategorySubById(subitemCategoryKey);
	// process adding
