...
<%@page
	import="com.ecims.portlet.currencymanagement.QuantityUnitManagementPortletUtil"%>
...
String unitKey = renderRequest.getParameter("unitKey");

try {
	util.deleteQuantityUnitById(unitKey);
	// process adding
