...
<% Currency currency = util.getCurrencyById(Id); %>
<% String name = (currency != null) ? currency.getName() : ""; %>
<% String htmlEntity = (currency != null) ? currency.getHtmlEntity() : ""; %>
<portlet:actionURL var="updateCurrencyURL" name="editAction">
...
<div style="padding-left:10px; padding-right:10px; width:900px">
	<div class="panel  panel-primary">
	  ...
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=updateCurrencyURL%>" method="post" enctype="application/x-www-form-urlencoded">
	     
		  <div style="padding-bottom:5px">
		  	<fieldset>
		  		<legend>Update Currency</legend>
		         <div>
				Name <input class=" form-control" type="text"  name="name" id="name" value="<%= name %>" />
				</div>
				<br/>
		        <div>
			Html Entity	<input class="form-control" type="text"  name="htmlEntity" id="htmlEntity" value="<%= htmlEntity %>" />
				</div>
				<input type="hidden" name="currencyKey" value="<%= Id %>" />
		  	</fieldset>
	      </div>
...
<p><a href="<%= viewCurrencyURL %>">&larr; Back</a></p>