<%@page import="com.ecims.portlet.feedback.FeedbackPortletState"%>
<%@page import="com.ecims.portlet.feedback.FeedbackPortletState.*"%>
...
FeedbackPortletState portletState = FeedbackPortletState.getInstance(renderRequest, renderResponse);
Logger log = Logger.getLogger(FeedbackPortletState.class);
ReCaptcha c = null;
...
<portlet:actionURL var="proceedToStepThree" name="processAction">
	<portlet:param name="action"
		value="<%=FEEDBACK_ACTIONS.CREATE_NEW_FEEDBACK.name()%>" />
</portlet:actionURL>
...
<div style="padding-left:10px; padding-right:10px;" class="col-sm-9 panel panel-default" role="news">
	<h4>ECIMS Feedback!!!</h4>
	<div class="panel  panel-primary">
	  <div class="panel-heading"><span style="color:white; font-weight: bold">Feedback on your User-Experience matters</span></div>
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" data-parsley-validate method="post" enctype="application/x-www-form-urlencoded">
	     <fieldset>
			  <legend>FeedBack On User-Experience
			  </legend>
			  ...
			  <div style="padding-bottom:5px"><strong>What has your experience been while using this system?<span style="color:red">*</span></strong>
				<div>
				  <textarea class="clear form-control formwidth50" type="text" data-parsley-required="true" value="<%=portletState.getExperience()==null ? "" : portletState.getExperience() %>" name="contents" id="contents" placeholder="Provide your experience here">
				  <%=portletState.getExperience()==null ? "" : portletState.getExperience() %>
				  </textarea>
				</div>
			  </div>
		  </fieldset>
	...
	<div style="padding:top:10px">
		<ul>
			<li>
				...
				<div>&nbsp;</div>
				<div><strong>Your Experience:</strong></div>
				<div>Provide details on your experience while using the system</div>
				<div>&nbsp;</div>
