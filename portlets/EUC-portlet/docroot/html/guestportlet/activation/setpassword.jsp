...
<div style="padding-left:10px; padding-right:10px; width:900px">
	...
	<div class="panel-heading"><span style="color:white; font-weight: bold">Step 2 of 2: Create Your Password</span></div>
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" method="post" enctype="application/x-www-form-urlencoded">
	     <center>
		  <div align="center" style="padding-bottom:5px"> <strong>Password:</strong>
	        <div>
	          <input class="clear form-control" type="password" onKeyUp="passwordStrength(this.value)" value="<%=portletState.getActivationEmail()==null ? "" : portletState.getActivationEmail() %>" 
	      ...
	      <div align="center" style="padding-bottom:5px"><strong>Confirm your Password:</strong>
	        ...
	        <div style="color:red">
	          Passwords must consist of 8 chracters and contain at least one special symbol (e.g. !#$%^&*,.":) and a number
	        </div>
	      ...
	      <div align="center">
	      	...
	      	<button type="submit" class="btn btn-success" id="savenutton" disabled="disabled" onclick="javascript:submitForm('proceed')">Save</button>
...
function submitForm(clicked)
{
	...
	if(passwordStrength(psd)==true)
	{
		document.getElementById('act').value=clicked;
		document.getElementById('startRegFormId').submit;
	}else
	{
		alert("Password strength is not strong enough. Ensure your password matches the specification in the help tips")	
	}
...
$(document).ready(function(){
	  $('#passwordconfirm').bind("paste",function(e) {
	      e.preventDefault();
	  });
	});
