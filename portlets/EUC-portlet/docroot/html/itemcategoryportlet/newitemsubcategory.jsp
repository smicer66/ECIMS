	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" data-validate="parsley" method="post" enctype="application/x-www-form-urlencoded">
	     <fieldset>
	      ...
	      <div>
	      	...
	      	<input type="hidden" value="<%=portletState.getItemCategoryEntity()==null ? "" : portletState.getItemCategoryEntity().getId() %>" name="actId" id="actId" />
	      	<button type="submit" class="btn btn-success" style="float:right" onclick="javascript:submitForm('createnewsubcategory')">Create New HS Code</button>
