...
<div style="padding-left:10px; padding-right:10px;" class="col-sm-9 panel panel-default" role="news">
	...
	<div class="panel  panel-primary">
	  <div class="panel-heading"><span style="color:white; font-weight: bold">HS Code Details</span></div>
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" data-validate="parsley" method="post" enctype="application/x-www-form-urlencoded">
	     <fieldset>
			  ...
			  <div style="padding-bottom:5px"> <strong>Item Category Name:<span style="color:red">*</span></strong>
				<div>
					...
					for(Iterator<ItemCategory> iter = portletState.getApplyItemCategoryList().iterator(); iter.hasNext();)
					{
						...
						selected = "";
						if(portletState.getItemCategorySubEntity()!=null && portletState.getItemCategorySubEntity().getItemCategory().getId().equals(itemCategory.getId()))
						{
			  ...
			  <div style="padding-bottom:5px"><strong>Item Sub Category Name:<span style="color:red">*</span></strong>
				<div>
				  	<input class="clear form-control formwidth50" type="text" data-required="true" value="<%=portletState.getItemSubCategoryName()==null ? "" : portletState.getItemSubCategoryName() %>" name="itemSubCategoryName" id="itemSubCategoryName" placeholder="Provide Name of Item Sub Category e.g. Fertilizer, Fireworks" />	
				</div>
			  </div>
			  
			  
			  <div style="padding-bottom:5px"><strong>Item Sub Category HS Code:<span style="color:red">*</span></strong>
				<div>
				  	<input class="clear for -control formwidth50" type="text" data-required="true" value="<%=portletState.getItemSubCategoryHSCode()==null ? "" : portletState.getItemSubCategoryHSCode() %>" name="itemSubCategoryHSCode" id="itemSubCategoryHSCode" placeholder="Provide HS Code of Item Sub Category e.g. HS1029" />
				</div>
			  </div>
	      ...
	      <div>
	      	...
	      	<input type="hidden" value="<%=portletState.getItemCategorySubEntity()==null ? "" : portletState.getItemCategorySubEntity().getId() %>" name="actId" id="actId" />
	      	<button type="submit" class="btn btn-success" style="float:right" onclick="javascript:submitForm('updatesubcategory')">Update New HS Code</button>
