...
<portlet:actionURL var="proceedToStepThree" name="processAction">
	<portlet:param name="action"
		value="<%=CURRENCY_ACTIONS.CREATE_NEW_CURRENCY.name()%>" />
</portlet:actionURL>
...
<div style="padding-left:10px; padding-right:10px;" class="col-sm-9 panel panel-default" role="news">
	<h4>Create An New Currency</h4>
	<div class="panel  panel-primary">
	  <div class="panel-heading"><span style="color:white; font-weight: bold">Currency Details</span></div>
	  <div class="panel-body">
	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" data-validate="parsley" method="post" enctype="application/x-www-form-urlencoded">
	     <fieldset>
			  <legend>Currency Details
			  </legend>
			  
			  
			  <div style="padding-bottom:5px"> <strong>Currency Name:<span style="color:red">*</span></strong>
				<div>
				  <input class="clear form-control formwidth50" type="text" data-required="true" value="<%=portletState.getCurrencyName()==null ? "" : portletState.getCurrencyName() %>" name="currencyName" id="currencyName" placeholder="Provide Name of Currency" />
				</div>
			  </div>
			  <div style="padding-bottom:5px"><strong>Currency Symbol:<span style="color:red">*</span></strong>
				<div>
				  <input class="clear form-control formwidth50" type="text" data-required="true" value="<%=portletState.getHtmlName()==null ? "" : portletState.getHtmlName() %>" name="htmlName" id="htmlName" placeholder="Provide Currency Symbol" />
				</div>
			  </div>
	      ...
	      <div>
	      	...
	      	<button type="submit" class="btn btn-success" style="float:right" onclick="javascript:submitForm('createnewagency')">Create New Currency</button>
	...
	<div style="padding:top:10px">
		<ul>
			<li>
				...
				<div>e.g. USSD for USA, NGN for Nigeria</div>
				<div>&nbsp;</div>
