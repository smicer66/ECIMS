...
<portlet:actionURL var="newagency" name="processAction">
	<portlet:param name="action"
		value="<%=VIEW_TABS.VIEW_NEW_PORTCODE.name()%>" />
		</portlet:actionURL>
		<portlet:actionURL var="newdesk" name="processAction">
	<portlet:param name="action"
		value="<%=VIEW_TABS.VIEW_PORTCODES.name()%>" />
		</portlet:actionURL>
...
if(portletState.getCurrentTab()!=null && portletState.getCurrentTab().equals(VIEW_TABS.VIEW_NEW_PORTCODE))
{
	newagencyclass="label-primary";
}if(portletState.getCurrentTab()!=null && portletState.getCurrentTab().equals(VIEW_TABS.VIEW_PORTCODES))
{
