	    ...
	    <form  id="startRegFormId" action="<%=proceedToStepFour%>" method="post" enctype="application/x-www-form-urlencoded">
	     	...
	     	<fieldset>
			  ...
			  <div style="padding-bottom:5px">
				<div>
					...
					<%if(portletState.getSelectedApplicant().getPortalUser().getPassportPhoto()!=null){ %>
					<img src="<%=folder + "/" + "uploadedfiles" + "/" + portletState.getSelectedApplicant().getPortalUser().getPassportPhoto()%>" height="50px;">
					<%}%>
				</div>
			  </div>
		  ...
		  <fieldset>
			  <legend>Means of Identification
				  ...
				  <div style="padding-bottom:5px">
					<div>
					  	<%=(portletState.getSelectedApplicant().getPortalUser().getIdentificationHistory()!=null && 
				  ...
				  <div style="padding-bottom:5px">
					<div>
					  	...
					  	<img src="<%=folder + "/" + "uploadedfiles" + "/" + portletState.getSelectedApplicant().getPortalUser().getIdentificationHistory().getIdentificationPhoto()%>" height="50px;">
					</div>
				  </div>
				  <div style="padding-bottom:5px">
					<div>
			  ...
			  <legend>Company Details
				  ...
				  <div style="padding-bottom:5px">
					<div>
						...
						<div>
						  <%=portletState.getSelectedApplicant().getPortalUser().getCompany().getCertificateDate()==null ? "N/A" : 
							  sdf.format(portletState.getSelectedApplicant().getPortalUser().getCompany().getCertificateDate()) %>
						</div>
					</div>
				  </div>
				  <div style="padding-bottom:5px">
					<div>
					  	<strong>Your Company Logo:</strong><br><img src="<%=folder + "/" + "uploadedfiles" + "/" + portletState.getSelectedApplicant().getPortalUser().getCompany().getLogo()%>" height="50px;">
					</div>
				  </div>
				  <div style="padding-bottom:5px">
					<div>
					  	<strong>Your Company's Certificate of Incorporation:<br><img src="<%=folder + "/" + "uploadedfiles" + "/" + portletState.getSelectedApplicant().getPortalUser().getCompany().getCertificate()%>" height="50px;">
					</div>
				  </div>
		  <fieldset>
...
{
	if(clicked=='reject' && document.getElementById('rejectreason').value.length==0)
	{
		alert('Provide reasons for rejecting this signup request before proceedng');
	}else
	{
