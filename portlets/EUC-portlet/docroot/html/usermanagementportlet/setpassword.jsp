...
<portlet:actionURL var="proceedToStepThree" name="processAction">
	<portlet:param name="action"
		value="<%=EUC_DESK_ACTIONS.CREATE_NEW_PASSWORD_PORTAL_USER_ACCOUNT.name()%>" />
</portlet:actionURL>
...
<div style="padding-left:10px; padding-right:10px; width:900px">
	...
	<div class="panel-heading"><span style="color:white; font-weight: bold">Update Your Password</span></div>
	  <div class="panel-body">
	  	<center>
	    <div style="width:300px; text-align: center">	
	    <form  id="startRegFormId" action="<%=proceedToStepThree%>" method="post" enctype="application/x-www-form-urlencoded">
	     <center>
		  <div align="center" style="padding-bottom:5px"> <strong>Current Password:</strong>
	        <div>
	          <input class="clear form-control formwidth50" data-required="true" type="password" 
	          name="oldpassword" id="oldpassword" placeholder="Provide your password" />
	        </div>
	      </div>
	      
		  <div align="center" style="padding-bottom:5px"> <strong>New Password:</strong>
	        <div>
	          <input class="clear form-control formwidth50" onKeyUp="passwordStrength(this.value)" type="password" data-required="true" 
	      ...
	      <div align="center" style="padding-bottom:5px"><strong>Confirm your Password:</strong>
	        <div>
	          <input class="clear form-control formwidth50" type="password" data-required="true" value="" name="passwordconfirm" id="passwordconfirm" placeholder="Retype your password" />
	        </div>
	      </div>
...
function mouseoverPass(obj) {
	if(document.getElementById('seepassword').checked)
	{
	 	...
	 	var obj2 = document.getElementById('oldpassword');
	 	obj2.type = "text";
	 	obj.type = "text";
	  	obj1.type = "text";
	}else
